...
>
> Última actualización: **2026-05-20** · **23 discoveries** + **1 artefacto de soporte**
...
|---|---|---|---|---|---|
| [`lex-operatoria-rulo-quotes-discovery.md`](./lex-operatoria-rulo-quotes-discovery.md) | LEX — Visibilidad de quotes del rulo en el detalle de cliente | En investigación | Santino Domeniconi | 2026-05-20 | — |
...
Archivos que viven en `discoveries/` pero **no son discoveries** — son insumos o salidas auxiliares de un discovery (briefings, transcripts, drafts intermedios). Se nombran con un sufijo distinto a `-discovery.md` para hacerlo evidente.
