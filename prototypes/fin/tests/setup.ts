...
// NOTE: resetFinSeed not imported — FIN-specific seeds (Disponibilidades,
// Cotizaciones) still live under src/mocks/fin/* on the legacy pattern.
// They'll join here when Disponibilidades is migrated.
