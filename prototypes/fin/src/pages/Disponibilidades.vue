...
const MOVIMIENTOS_KANBAN_AXES: Record<AxisId, KanbanAxis> = {
  ...
  tipo: {
    ...
    states: [
      ...
      { id: 'AJUSTE_CREDITO', label: 'AJUSTE_CR', order: 8 },
      { id: 'AJUSTE_DEBITO', label: 'AJUSTE_DB', order: 9 },
      { id: 'MOV_ENTRE_CUENTAS_PROPIAS', label: 'MOV_CUENTAS', order: 10 },
      { id: 'PRESTAMO_INTERCOMPANY', label: 'PRESTAMO_IC', order: 11 },
      { id: 'SWEEPING_CROSS_SOCIEDAD', label: 'SWEEPING_CS', order: 12 },
      { id: 'COMISION_BANCARIA', label: 'COMISION_BCO', order: 13 },
      { id: 'INTERES_BANCARIO', label: 'INTERES_BCO', order: 14 },
      { id: 'PAGO_PROVEEDOR', label: 'PAGO_PROV', order: 15 },
      { id: 'PAGO_SALARIOS', label: 'PAGO_SAL', order: 16 },
      { id: 'APORTE_CAPITAL', label: 'APORTE_CAP', order: 17 },
      { id: 'AJUSTE_MANUAL', label: 'AJUSTE_MAN', order: 18 },
    ],
    transitions: [],
    read_only: true,
  },
