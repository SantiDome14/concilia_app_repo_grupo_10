...
const LIST = apiPath(ENDPOINTS.solicitudes.list);
const ITEM = apiPath(ENDPOINTS.solicitudes.detail(':id'));
const CREATE = apiPath(ENDPOINTS.solicitudes.create);
const UPDATE = apiPath(ENDPOINTS.solicitudes.update(':id'));
