...
const REPORTS_LIST = apiPath(ENDPOINTS.reports.list);
const REPORT_ITEM = apiPath(ENDPOINTS.reports.detail(':id'));
const REPORT_UPDATE = apiPath(ENDPOINTS.reports.update(':id'));
const CATEGORIES_LIST = apiPath(ENDPOINTS.reports.categories);
const RUNS_LIST = apiPath(ENDPOINTS.reports.runs.list);
const RUNS_CREATE = apiPath(ENDPOINTS.reports.runs.create);
