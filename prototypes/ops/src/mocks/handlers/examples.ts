...
const LIST = apiPath(ENDPOINTS.example.list);
const ITEM = apiPath(ENDPOINTS.example.detail(':id'));
const CREATE = apiPath(ENDPOINTS.example.create);
const UPDATE = apiPath(ENDPOINTS.example.update(':id'));
const DELETE = apiPath(ENDPOINTS.example.delete(':id'));
