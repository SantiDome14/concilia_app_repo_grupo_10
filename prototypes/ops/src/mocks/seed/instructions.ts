...
const initialInstructions: Instruction[] = [
  ...
  {
    id: 'tpl-convera-pool',
    name: 'Template Convera Pool',
    currency_id: 'cur-usdc',
    description: 'Template Clientes Ardua Convera',
    created_at: now,
    updated_at: now,
    attributes_count: 4,
  },
  {
    id: 'tpl-standard-usd-wire',
    name: 'Standard USD Wire',
    currency_id: 'cur-usd',
    description: 'Standard SWIFT/WIRE for USD outbound transfers.',
    created_at: now,
    updated_at: now,
    attributes_count: 4,
  },
...
const initialAttributes: SeedAttribute[] = [
  ...
  // instruccion pool test qa
  {
    id: 'attr-pool-01',
    instruction_id: 'tpl-pool-test-qa',
    key: 'account_number',
  ...
  },
  {
    ...
    key: 'reference',
    display: 'Reference',
    default_value: '9090{docket}',
    value: '9090{docket}',
    index_order: 1,
  },

  // Template Convera Pool
  {
    id: 'attr-convera-01',
    instruction_id: 'tpl-convera-pool',
    key: 'account_holder',
  ...
  {
    id: 'attr-stdwire-01',
    instruction_id: 'tpl-standard-usd-wire',
    key: 'bank',
    display: 'Banco',
