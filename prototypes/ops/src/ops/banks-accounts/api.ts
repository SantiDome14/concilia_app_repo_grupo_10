...
const ENDPOINTS = {
  ...
  updateAccount: (id: string): string => `/banks-accounts/${id}`,
  listSociedades: '/banks-accounts/sociedades',
  listEstructuras: '/banks-accounts/structures',
} as const;
...
export async function fetchBanksAccounts(): Promise<BankAccountRecord[]> {
  const response = await apiClient.get<unknown>(ENDPOINTS.list);
...
export async function fetchSociedades(): Promise<Sociedad[]> {
  const response = await apiClient.get<unknown>(ENDPOINTS.listSociedades);
...
export async function fetchEstructuras(): Promise<Estructura[]> {
  const response = await apiClient.get<unknown>(ENDPOINTS.listEstructuras);
...
export async function createStructure(payload: CreateStructurePayload): Promise<Estructura> {
  ...
  const response = await apiClient.post<unknown>(ENDPOINTS.createStructure, body);
...
export async function createAccount(payload: CreateAccountPayload): Promise<BankAccountRecord> {
  ...
  const response = await apiClient.post<unknown>(ENDPOINTS.createAccount, body);
...
export async function updateAccount(
  ...
  const response = await apiClient.patch<unknown>(ENDPOINTS.updateAccount(id), body);
  return bankAccountRecordSchema.parse(response.data);
}
