...
| # | Slug | Status | Notes |
|---|------|--------|-------|
| 2.1 | `add-trd-bots-placeholder` | Not started | Sidebar entry under **Catálogos** block (Yasmani session 6). `soon: true` + page that renders `<ModuloSoon>`. No backend wiring. |
